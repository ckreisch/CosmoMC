    ...
    integer, parameter :: action_MCMC=0, action_importance=1, action_maxlike=2, action_hessian=3, action_tests=4, action_MultiNest=5 
    ...
    this%action = Ini%Read_Int('action',action_MCMC,min=0,max=action_MultiNest)
